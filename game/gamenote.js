  ...
  Q.Stage.extend("Stage",{
    ...
    point: function(text,p) {
      ...
      if(!this.container) {
        ...
        pt.p.x = 512;
        pt.p.align = 'center'
        pt.animate({ opacity: 1.0 },null,null,{ delay: 0.2 });
   ...
   scroller: function(asset,titleText,labelText) {
     ...
     var title = this.insert(new Q.UI.Text({ label: titleText.toUpperCase(), size: 40, family: "atrament-web", color: "#C0322D", x: 490, y: 180, align:'left', opacity: 0, z:2  }).add("tween"));
     var label = this.insert(new Q.UI.Text({ label: labelText, size: 20, family: "proxima-nova", weight:400, color: "black", x: 490, y: 240, opacity: 0, z:2 }).add("tween"));
